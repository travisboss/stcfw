...
<div class="hero min-h-0 bg-base-200">
	<div class="hero-content text-center">
		<div class="max-w-xxl">
			<a
				class="link link-neutral my-6"
				href="https://app.frame.io/presentations/dc276c7c-90b8-4bc5-8f89-6510a2949e73"
				>2022 Honorary Fireworks Commissioner (click to view)</a
			>
			<p>
				<br />
