...
<div class="hero min-h-screen bg-base-200">
	<div class="hero-content">
		<div class="max-w-4xl">
			<h1 class="text-3xl font-bold text-center">History, Celebration, Tradition</h1>
			<p class="pb-1 pt-6 text-left">
				For over 70 years, the St. Cloud July 4th Fireworks have lit up the sky to commemorate
			...
			<p class="py-1">
				The St. Cloud Fireworks Committee is a 501(c)3 non-profit organization that works throughout
			...
			<p class="py-1">
				The July 4th Fireworks are organized and sponsored by the St. Cloud Fireworks Committee, an
			...
			<p class="py-1">
				The Fourth of July is the quintessential American holiday – St. Cloud has the perfect
			...
			<p class="py-1">
				The first July 4th Fireworks displays were launched in St. Cloud at Lake George starting in
			...
			<p class="py-1">
				Today, thousands of area residents and visitors spanning multiple generations, come together
